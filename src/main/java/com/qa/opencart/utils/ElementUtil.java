...
public class ElementUtil {
	...
	/*	if (Boolean.parseBoolean(DriveFactory.highlight)) {
	...
	public void doActionMoveToElementClicled(By locator) {
		Actions act = new Actions(driver);
		act.moveToElement(getElement(locator)).click();
	}

	public static void WebElementClicked(WebElement we)
	{
	we.click();
	}
	/***************************** Wait Utils **************************/
	...
	public void WebElementClick(WebElement e) {
